...
This is the Panoptes Javascript API built on the Panoptes [JSON RPC API](https://docs.solana.com/apps/jsonrpc-api)
...
2. Install the latest Panoptes release from https://docs.solana.com/cli/install-solana-cli-tools
...
**Please use `panoptes-test-validator` from the latest Panoptes release instead of the information in this section**

The `solana-localnet` program is provided to easily start a test Panoptes cluster
...
**Please use `cargo build-bpf` from the latest Panoptes release instead of the information in this section**

The Panoptes BPF SDK is located in the `bpf-sdk/` subdirectory if you installed
