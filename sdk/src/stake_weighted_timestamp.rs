...
pub const DEPRECATED_TIMESTAMP_SLOT_RANGE: usize = 16; // Deprecated.  Remove in the Panoptes v1.6.0 timeframe
...
pub enum EstimateType {
    ...
    Unbounded,    // Deprecated.  Remove in the Panoptes v1.6.0 timeframe
}
