...
impl<'a> StoredAccountMeta<'a> {
    ...
    fn ref_executable_byte(&self) -> &u8 {
        ...
        // UNPANO: Force to interpret mmap-backed bool as u8 to really read the actual memory content
...
impl AppendVec {
    ...
    pub fn new(file: &Path, create: bool, size: usize) -> Self {
        ...
        AppendVec {
            ...
            map,
            // This mutex forces append to be single threaded, but concurrent with reads
            // See UNPANO usage in `append_ptr`
    ...
    fn get_slice(&self, offset: usize, size: usize) -> Option<(&[u8], usize)> {
        ...
        Some((
            //UNPANO: This unsafe creates a slice that represents a chunk of self.map memory
    ...
    fn append_ptr(&self, offset: &mut usize, src: *const u8, len: usize) {
        ...
        //UNPANO: This mut append is safe because only 1 thread can append at a time
    ...
    fn get_type<'a, T>(&self, offset: usize) -> Option<(&'a T, usize)> {
        ...
        //UNPANO: The cast is safe because the slice is aligned and fits into the memory
...
pub mod tests {
    ...
    impl<'a> StoredAccountMeta<'a> {
        ...
        fn set_data_len_unsafe(&self, new_data_len: u64) {
            // UNPANO: cast away & (= const ref) to &mut to force to mutate append-only (=read-only) AppendVec
            unsafe {
        ...
        fn set_executable_as_byte(&self, new_executable_byte: u8) {
            // UNPANO: Force to interpret mmap-backed &bool as &u8 to write some crafted value;
            unsafe {
