...
test('transaction-payer', async () => {
  ...
  mockRpc.push([
    url,
    {
      ...
      params: [accountPayer.publicKey.toBase58(), LAMPORTS_PER_PANO],
    },
    {
      error: null,
      result:
  ...
  mockRpc.push([
    ...
    },
    {
      ...
      result: {
        ...
        value: LAMPORTS_PER_PANO - 1,
      },
    },
  ]);

  // accountPayer should be less than LAMPORTS_PER_PANO as it paid for the transaction
  ...
  expect(balance).toBeLessThanOrEqual(LAMPORTS_PER_PANO);
