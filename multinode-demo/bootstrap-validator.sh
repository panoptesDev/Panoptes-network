...
identity=$PANOPTES_CONFIG_DIR/bootstrap-validator/identity.json
vote_account="$PANOPTES_CONFIG_DIR"/bootstrap-validator/vote-account.json

ledger_dir="$PANOPTES_CONFIG_DIR"/bootstrap-validator
[[ -d "$ledger_dir" ]] || {
